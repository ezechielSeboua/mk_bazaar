...
function SkeletonCard() {
    return (
        <div className="bg-white rounded-xl border border-stone-200 overflow-hidden h-[280px] sm:h-[420px] md:h-[460px] animate-pulse flex flex-col justify-between">
                    ...
                    inStockProducts.map((product, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                whileHover={{ y: -6 }}
                                className="group flex flex-col justify-between bg-white rounded-xl border border-stone-200/80 overflow-hidden h-[280px] sm:h-[380px] md:h-[460px] transition-all duration-300 hover:border-stone-400 hover:shadow-md"
                            >
                                <Link to={`/products/${product.slug}`} className="flex flex-col flex-grow overflow-hidden">
                                    <div className="relative w-full h-[48%] bg-stone-100 overflow-hidden">
                                        ...
                                        <div className="absolute top-2 right-2 z-10">
                                            <span className="inline-flex items-center px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-stone-900 text-white border border-stone-800 rounded-md shadow-sm">
                                                En stock
                                            </span>
                                        </div>
                                    </div>

                                    <div className="flex flex-col justify-between flex-grow p-2.5 sm:p-4 bg-white text-stone-900">
                                        <div>
                                ...
                                <div className="p-2.5 bg-white border-t border-stone-100">
                                    <Link to={`/products/${product.slug}`} className="block">
                                        <motion.div
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            className="w-full py-2 sm:py-2.5 rounded-lg flex items-center justify-center gap-1.5 text-[11px] sm:text-xs font-bold uppercase tracking-wider bg-stone-950 text-white hover:bg-green-600 shadow-sm transition-all duration-200 min-h-[44px]"
                                        >
                                            <WhatsAppIcon />
                                            <span>Commander</span>
                                        </motion.div>
