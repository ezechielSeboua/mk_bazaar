...
const CapybaraLoader: React.FC = () => {
  return (
    <>
      <style>{`
        .capybaraloader { width: 14em; height: 10em; position: relative; z-index: 1; --color: rgb(204, 125, 45); --color2: rgb(83, 56, 28); transform: scale(0.5); }
