    ...
    >
      ...
      <div className="p-3 pt-0 flex flex-col gap-2">
        <button
          ...
          className={`w-full py-3 rounded-lg text-[8px] sm:text-[12px] font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all ${isAvailable ? "bg-[#c07b5a] text-white hover:bg-[#a5684a]" : "bg-stone-100 text-stone-400 cursor-not-allowed"}`}
        >
